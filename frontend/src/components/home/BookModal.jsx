    ...
    >
      ...
      >
        <AiOutlineClose
          ...
          onClick={onClose}
        />
        <h2 className='w-fit px-4 py-1 bg-blue-400 rounded-lg text-white hover:bg-blue-500 hover:text-black hover:cursor-pointer'>
          {book.publishYear}
        </h2>
        <h4 className='my-2 text-black text-xs'> Id : {book._id}</h4>
